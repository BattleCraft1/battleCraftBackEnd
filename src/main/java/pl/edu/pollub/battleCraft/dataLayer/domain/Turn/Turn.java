package pl.edu.pollub.battleCraft.dataLayer.domain.Turn;
...
public class Turn {
    ...
    public Turn(int number, int battlesCount, Tournament tournament){
        this.number = number;
    ...
    @JsonIgnore
    @OneToMany(orphanRemoval = true, cascade = CascadeType.ALL, mappedBy = "turn")
