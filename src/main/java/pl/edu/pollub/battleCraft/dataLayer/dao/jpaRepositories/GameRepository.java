...
public interface GameRepository extends JpaRepository<Game, Long> {
    ...
    List<String> selectGamesNamesToDeleteUniqueNames(String... gamesToDeleteUniqueNames);
    ...
    List<String> selectGamesNamesToAcceptUniqueNames(String... gamesToAcceptUniqueNames);
    ...
    List<String> selectGamesNamesToRejectUniqueNames(String... gamesToCancelAcceptUniqueNames);
