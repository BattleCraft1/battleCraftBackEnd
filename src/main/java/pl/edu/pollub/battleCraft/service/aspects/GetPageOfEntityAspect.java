...
public class GetPageOfEntityAspect {
    ...
    @AfterReturning(pointcut="execution(* pl.edu.pollub.battleCraft.data.repositories.*Repository.*(..)) && args(*,pageRequest)", returning="fetchedPage", argNames = "pageRequest,fetchedPage")
